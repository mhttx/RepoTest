...
INSERT INTO `thinkox_menu` ( `title`, `pid`, `sort`, `url`, `hide`, `tip`, `group`, `is_dev`) VALUES
( 'App管理', @tmp_id,1, 'App/app', 0, '', 'App', 0),
( 'App详情', @tmp_id,2, 'App/appdetail', 0, '', 'App', 0),
( 'App上传', @tmp_id,3, 'App/appupload', 0, '', 'App', 0),
( '反馈消息管理', @tmp_id,4, 'App/feedback', 0, '', '反馈消息', 0),
( '反馈消息详情', @tmp_id,5, 'App/Feedbackdetail', 0, '', '反馈消息', 0),
( '反馈消息回收站', @tmp_id,6, 'App/feedbackTrash', 0, '', '反馈消息', 0)；
...
public function setfilePostUrl($url)
    {
        $this->_setfilePostUrl = $url;
        return $this;
    }
    ...
    public function display($html = 'admin_list')
    {
        //key类型的等价转换
        //map转换成text
        ...
        $this->assign('filePostUrl', $this->_setfilePostUrl);
        parent::display($html);
    }

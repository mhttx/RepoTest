...
<head>
    ...
    <link href="/app/Public/favicon.ico" type="image/x-icon" rel="shortcut icon">
    <link rel="stylesheet" type="text/css" href="/app/Public/Admin/css/base.css" media="all">
    <link rel="stylesheet" type="text/css" href="/app/Public/Admin/css/common.css" media="all">
    <link rel="stylesheet" type="text/css" href="/app/Public/Admin/css/module.css">
    <link rel="stylesheet" type="text/css" href="/app/Public/Admin/css/style.css" media="all">
    <link rel="stylesheet" type="text/css" href="/app/Public/Admin/css/<?php echo (C("COLOR_STYLE")); ?>.css" media="all">
    <!--[if lt IE 9]>
    ...
    <script type="text/javascript" src="/app/Public/Admin/js/jquery.mousewheel.js"></script>
    <!--<![endif]-->
...
<div id="main-content">
    ...
    <script type="text/javascript" src="/app/Public/static/uploadify/jquery.uploadify.min.js"></script>
                    ...
                    <?php case "image": ?><div class="controls">
                        ...
                        <script type="text/javascript">
                            ...
                            $("#upload_picture_<?php echo ($field["name"]); ?>").uploadify({
                                "height"          : 30,
                                "swf"             : "/app/Public/static/uploadify/uploadify.swf",
...
<script type="text/javascript" src="/app/Public/static/think.js"></script>
...
<script type="text/javascript">
    ...
    <?php if($importDatetimePicker): ?><link href="/app/Public/static/datetimepicker/css/datetimepicker.css" rel="stylesheet" type="text/css">
        <?php if(C('COLOR_STYLE')=='blue_color') echo '<link href="/app/Public/static/datetimepicker/css/datetimepicker_blue.css" rel="stylesheet" type="text/css">'; ?>
        <link href="/app/Public/static/datetimepicker/css/dropdown.css" rel="stylesheet" type="text/css">
        <script type="text/javascript" src="/app/Public/static/datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
        <script type="text/javascript" src="/app/Public/static/datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>

...
<head>
    ...
    <link href="/v/Public/favicon.ico" type="image/x-icon" rel="shortcut icon">
    <link rel="stylesheet" type="text/css" href="/v/Public/Admin/css/base.css" media="all">
    <link rel="stylesheet" type="text/css" href="/v/Public/Admin/css/common.css" media="all">
    <link rel="stylesheet" type="text/css" href="/v/Public/Admin/css/module.css">
    <link rel="stylesheet" type="text/css" href="/v/Public/Admin/css/style.css" media="all">
    <link rel="stylesheet" type="text/css" href="/v/Public/Admin/css/<?php echo (C("COLOR_STYLE")); ?>.css" media="all">
    <!--[if lt IE 9]>
    ...
    <script type="text/javascript" src="/v/Public/Admin/js/jquery.mousewheel.js"></script>
    <!--<![endif]-->
...
<body>
<form action='<?php echo ($filePostUrl); ?>' method='post' enctype="multipart/form-data" class="app2">
...
<div><input type="reset" value="重置" class="input"/><input type="submit" value="提交" name='sub' class="input"/></div>
    ...
    <script type="text/javascript" src="/v/Public/static/thinkbox/jquery.thinkbox.js"></script>
    <script type="text/javascript">
//        //搜索功能
...
<script type="text/javascript" src="/v/Public/static/think.js"></script>
<script type="text/javascript" src="/v/Public/Admin/js/common.js"></script>
<script type="text/javascript">
    +function () {

...
<link href="/v/Public/static/bootstrap/css/bootstrap.css" rel="stylesheet"/>
<link type="text/css" rel="stylesheet" href="/v/Public/static/qtip/jquery.qtip.css"/>
<link type="text/css" rel="stylesheet" href="/v/Public/Core/js/ext/toastr/toastr.min.css"/>
<link href="/v/Public/Core/css/oneplus.css" rel="stylesheet"/>
<link type="text/css" rel="stylesheet" href="/v/Public/Core/js/ext/magnific/magnific-popup.css"/>


<!-- 增强IE兼容性 -->
<!-- Le HTML5 shim, for IE6-8 support of HTML5 elements -->
<!--[if lt IE 9]>
<script src="/v/Public/static/bootstrap/js/html5shiv.js"></script>
<script src="/v/Public/static/bootstrap/js/respond.js"></script>
<![endif]-->

<!-- jQuery库 -->
<!--[if lt IE 9]>
<script type="text/javascript" src="/v/Public/static/jquery-1.10.2.min.js"></script>
<![endif]-->
<!--[if gte IE 9]><!-->
<script type="text/javascript" src="/v/Public/static/jquery-2.0.3.min.js"></script>
<!--<![endif]-->

<!--合并前的js-->
<!-- Bootstrap库 -->
<script type="text/javascript" src="/v/Public/static/bootstrap/js/bootstrap.min.js"></script>

<!-- 其他库-->
<script src="/v/Public/static/qtip/jquery.qtip.js"></script>
<script type="text/javascript" src="/v/Public/Core/js/ext/toastr/toastr.min.js"></script>
<script type="text/javascript" src="/v/Public/Core/js/ext/slimscroll/jquery.slimscroll.min.js"></script>
<script type="text/javascript" src="/v/Public/static/jquery.iframe-transport.js"></script>

<script type="text/javascript" src="/v/Public/Core/js/ext/lazyload/lazyload.js"></script>
<script type="text/javascript" src="/v/Public/Core/js/ext/magnific/jquery.magnific-popup.min.js"></script>
<!--CNZZ广告管家，可自行更改-->
<!--<script type='text/javascript' src='http://js.adm.cnzz.net/js/abase.js'></script>-->
<!--CNZZ广告管家，可自行更改end
 自定义js-->
<script type="text/javascript" src="/v/Public/Core/js/core.js"></script>
<!--合并前的js-->
<?php $config = api('Config/lists'); C($config); $icp=C('WEB_SITE_ICP'); $count_code=C('COUNT_CODE'); ?>
<script type="text/javascript">
    var ThinkPHP = window.Think = {
        "ROOT": "/v", //当前网站地址
        "APP": "/v/index.php?s=", //当前项目地址
        "PUBLIC": "/v/Public", //项目公共目录地址
...
<!--CNZZ广告管家，可自行更改end-->
<!-- 自定义js -->
<!--<script src="/v/Public/js.php?get=<?php echo implode(',',$js);?>"></script>-->
...
<body>
	...
	<?php if((is_login()) ): ?><div id="right_panel" class="friend_panel visible-md visible-lg" style="display: none;">
        <a class="btn-pull" onclick="show_panel()"> <img style="width: 30px" src="/v/Public/Core/images/friend.png"/> </i>
            <script>
                function show_panel() {
        ...
        <?php if(count($currentSession) == 0): ?><div id="right_panel_main" style="display: none;">
                <div style="color: white;line-height: 500px;font-size: 16px;padding:10px;">
                    <img src="/v/Public/Core/images/loading.gif"/>
                </div>
            </div>
            <?php else: ?>
    ...
    <div id="chat_box" style="display: none" class="chat_panel weibo_post_box">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <a href="javascript:" onclick="insertFace($(this))"><img class="weibo_type_icon" src="/v/Public/static/image/bq.png"/></a>
            </div>
            <div class="col-md-6">
    ...
    <div id="right_panel" class="friend_panel visible-md visible-lg" style="display: none;">
        <a class="btn-pull" onclick="toast.error('请登陆后使用好友面板。','温馨提示')"> <img style="width: 30px" src="/v/Public/Core/images/friend.png"/> </i>
        </a>
    </div><?php endif; ?>
...
<div id="logo_bar" class="logo_bar" style="background: #03AE87">
    <div class="container">
        <div class="row logo">
            <div class="col-md-9">
                <a href="<?php echo U('Home/Index/index');?>"><img src="/v/Public/Core/images/logo.png"/></a>
            </div>
...
<div id="main-container" class="container">
    ...
    <link href="/v/Public/Weibo/css/weibo.css" rel="stylesheet"/>


    <!--微博内容列表部分-->
    <div class="weibo_left col-md-9">
        <?php if(is_login() && check_auth('sendWeibo')): ?><div class="row">
        <div class="col-xs-12">
...
<script type="text/javascript" src="/v/Public/Core/js/ext/placeholder/placeholder.js"></script>
<script type="text/javascript" src="/v/Public/Core/js/ext/atwho/atwho.js"></script>
<link type="text/css" rel="stylesheet" href="/v/Public/Core/js/ext/atwho//atwho.css"/>



    <script src="/v/Public/Weibo/js/weibo.js"></script>
    <script>

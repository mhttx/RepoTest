<?php if (!defined('THINK_PATH')) exit(); if($list['type'] == 2): if(count($list['res']) > 0): switch($list["style"]): case "2": ?><script src="/v/Public/Core/js/ext/kinmaxshow/js/kinmaxshow.min.js"></script>
            ...
            <?php default: ?>
                <script src="/v/Public/Core/js/ext/slider/js/jquery.slides.min.js"></script>
                <link href="/v/Public/Core/js/ext/slider/css/slider.css" rel="stylesheet" type="text/css"/>

    ...
    <div class="col-xs-9 login">
        <div class="col-md-6 col-xs-12 lg_left">
            <div class="col-xs-12">
                ...
                <form action="/v/index.php?s=/home/user/login.html" method="post" class="lg_lf_form " >
        ...
        <div class="col-md-6 col-xs-12">
            ...
            <div class="hidden-xs hidden-sm" style="margin: 21px 0 16px 40px;">
                <img class="img-responsive" src="/v/Public/Home/images/login_img.png" alt="">
            </div>
        ...
        <div class="col-xs-12 lg_bottom_top" style="font-size: 14px"><span>还没有账户&nbsp;?&nbsp; &nbsp; <a href="<?php echo U('Home/User/register');?>" title="">立即注册</a></span></div>
        <div class="col-xs-12 lg_bottom_bottom"><span>@2014. All Rights Reserved</span></div>
        <div class="clearfix"></div>
    </div>
